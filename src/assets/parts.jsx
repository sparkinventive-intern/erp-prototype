// Asset Management module — shared presentational parts.
...
const STATUS_CONFIG = {
  ...
  Disposed:     { bg: 'bg-slate-50',   text: 'text-slate-600',   dot: 'bg-slate-400',   ring: 'ring-slate-200'   },
  ...
  Quotation:    { bg: 'bg-[#EBF0FB]', text: 'text-navy',        dot: 'bg-navy',        ring: 'ring-[#C5D2F0]'  },
  Committee:    { bg: 'bg-violet-50',  text: 'text-violet-700',  dot: 'bg-violet-500',  ring: 'ring-violet-200'  },
  ...
  New:          { bg: 'bg-[#EBF0FB]', text: 'text-navy',        dot: 'bg-navy',        ring: 'ring-[#C5D2F0]'  },
}
