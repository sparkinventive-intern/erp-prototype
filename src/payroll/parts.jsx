// Payroll module — shared presentational parts.
...
const STATUS_CONFIG = {
  ...
  Hold:      { bg: 'bg-red-50',      text: 'text-red-700',     dot: 'bg-red-500',      ring: 'ring-red-200'     },
  Failed:    { bg: 'bg-rose-50',     text: 'text-rose-700',    dot: 'bg-rose-500',     ring: 'ring-rose-200'    },
  Processed: { bg: 'bg-[#EBF0FB]',  text: 'text-navy',        dot: 'bg-navy',         ring: 'ring-[#C5D2F0]'  },
