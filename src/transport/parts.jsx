// Transport module — shared presentational parts.
...
const STATUS_CONFIG = {
  ...
  Maintenance:  { bg: 'bg-orange-50',   text: 'text-orange-700',  dot: 'bg-orange-500',   ring: 'ring-orange-200'  },
  Inactive:     { bg: 'bg-slate-50',    text: 'text-slate-600',   dot: 'bg-slate-400',    ring: 'ring-slate-200'   },
  Leave:        { bg: 'bg-amber-50',    text: 'text-amber-700',   dot: 'bg-amber-500',    ring: 'ring-amber-200'   },
  Paid:         { bg: 'bg-emerald-50',  text: 'text-emerald-700', dot: 'bg-emerald-500',  ring: 'ring-emerald-200' },
  Pending:      { bg: 'bg-red-50',      text: 'text-red-700',     dot: 'bg-red-500',      ring: 'ring-red-200'     },
  Partial:      { bg: 'bg-[#FFFBEB]',  text: 'text-amber-700',   dot: 'bg-[#F5B800]',   ring: 'ring-[#FDE68A]'  },
  Done:         { bg: 'bg-emerald-50',  text: 'text-emerald-700', dot: 'bg-emerald-500',  ring: 'ring-emerald-200' },
  'In Progress':{ bg: 'bg-[#EBF0FB]',  text: 'text-navy',        dot: 'bg-navy',         ring: 'ring-[#C5D2F0]'  },
  Scheduled:    { bg: 'bg-violet-50',   text: 'text-violet-700',  dot: 'bg-violet-500',   ring: 'ring-violet-200'  },
